...
import com.gilbram.whatsapp.Adapter.ConversationAdapter
...
class ConversationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (chatId.isNullOrEmpty() || userId.isNullOrEmpty()) {
            Toast.makeText(this, "chhat room error", Toast.LENGTH_SHORT).show()
            finish()
        }
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        menuInflater.inflate(R.menu.menu_convesation,menu)
        return true
    }
