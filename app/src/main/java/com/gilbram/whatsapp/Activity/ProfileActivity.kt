...
import com.gilbram.whatsapp.util.*
...
class ProfileActivity : AppCompatActivity() {
                    ...
                    filePath.downloadUrl
                        .addOnSuccessListener {
                            ...
                            firebaseDb.collection(DATA_USERS)
                                ...
                                .addOnSuccessListener {
                                    imageUrl = url
                                    populateImage(this,imageUrl,img_profil,R.drawable.ic_user)
                                }
    ...
    private fun populateInfo() {
        ...
        firebaseDb.collection(DATA_USERS).document(userId!!).get()
            .addOnSuccessListener{
                ...
                if (imageUrl != null){
                    populateImage(this,user?.imageUrl,img_profil,R.drawable.ic_user)
                }
                progress_layout_profile.visibility = View.GONE
            }
    ...
    private fun onDelete() {
        ...
        AlertDialog.Builder(this)
            ...
            .setMessage("Apakah Anda Inginn Menghapus Akun Ini?")
            .setPositiveButton("Ya"){dialog, which ->
                ...
                firebaseAuth.currentUser?.delete()?.addOnSuccessListener {
                    ...
                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK or Intent.FLAG_ACTIVITY_CLEAR_TASK)
                    Toast.makeText(this,"Akun di hapus" ,Toast.LENGTH_SHORT).show()
                    startActivity(intent)
                    finish()
