...
import com.gilbram.whatsapp.Adapter.SectionPagerAdapter
...
import com.gilbram.whatsapp.util.DATA_USER_PHONE
import com.gilbram.whatsapp.util.PERMISSION_REQUEST_READ_CONTACT
import com.gilbram.whatsapp.util.REQUEST_NEW_CHAT
...
class MainActivity : AppCompatActivity(), FailureCallback {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            R.id.acation_profile -> startActivity(Intent(this, ProfileActivity::class.java))
            R.id.acation_logout -> {
